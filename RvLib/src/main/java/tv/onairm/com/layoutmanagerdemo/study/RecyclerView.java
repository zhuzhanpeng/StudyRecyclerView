...
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.Callback;
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.UpdateOp;
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.UpdateOp.ADD;
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.UpdateOp.MOVE;
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.UpdateOp.REMOVE;
import static tv.onairm.com.layoutmanagerdemo.study.AdapterHelper.UpdateOp.UPDATE;
...
//    private final AccessibilityManager mAccessibilityManager;
    ...
    void consumePendingUpdateOperations() {
        ...
        if (mAdapterHelper.hasAnyUpdateTypes(UPDATE) && !mAdapterHelper
                .hasAnyUpdateTypes(ADD | REMOVE | MOVE)) {
...
//        return mAccessibilityManager != null && mAccessibilityManager.isEnabled();
    ...
    public static class RecycledViewPool {
        ...
        public int getScrapCount(int viewType){
            int count=0;
            final ArrayList<ViewHolder> scrapHeap = mScrap.get(viewType);
            return (null==scrapHeap)?0:scrapHeap.size();
        }
