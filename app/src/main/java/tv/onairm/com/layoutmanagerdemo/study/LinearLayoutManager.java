...
package tv.onairm.com.layoutmanagerdemo.study;
...
import tv.onairm.com.layoutmanagerdemo.study.RecyclerView.LayoutParams;
import tv.onairm.com.layoutmanagerdemo.study.helper.ItemTouchHelper;

import static android.support.annotation.RestrictTo.Scope.GROUP_ID;
import static tv.onairm.com.layoutmanagerdemo.study.RecyclerView.NO_POSITION;

/**
 * A {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView.LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class LinearLayoutManager extends tv.onairm.com.layoutmanagerdemo.study.RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     * {@link #onLayoutChildren(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State)} is run.
     */
    ...
    * */
     ...
     * RecyclerView.
     * <p>
     * If you are using a {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView.RecycledViewPool}, it might be a good idea to set
    ...
    @Override
    public void onDetachedFromWindow(tv.onairm.com.layoutmanagerdemo.study.RecyclerView view, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler) {
    ...
    /**
     * Sets the orientation of the layout. {@link tv.onairm.com.layoutmanagerdemo.study.LinearLayoutManager}
     ...
     * When set to true, If {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView} is LTR, than it will
     * layout from RTL, if {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView}} is RTL, it will layout
     * from LTR.
     *
     ...
     * By default, {@link tv.onairm.com.layoutmanagerdemo.study.LinearLayoutManager} lays out 1 extra page of
     ...
     */
    protected int getExtraLayoutSpace(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
    ...
    @Override
    public void smoothScrollToPosition(tv.onairm.com.layoutmanagerdemo.study.RecyclerView recyclerView, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state,
                                       int position) {
     ...
     */
    @Override
    public void onLayoutChildren(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
    ...
    @Override
    public void onLayoutCompleted(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
     ...
     *                                 indices.
     */
    void onAnchorReady(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state,
     ...
     */
    private void layoutForPredictiveAnimations(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                               tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, int startOffset, int endOffset) {
        ...
        final List<tv.onairm.com.layoutmanagerdemo.study.RecyclerView.ViewHolder> scrapList = recycler.getScrapList();
        final int scrapSize = scrapList.size();
        final int firstChildPos = getPosition(getChildAt(0));
        for (int i = 0; i < scrapSize; i++) {
            tv.onairm.com.layoutmanagerdemo.study.RecyclerView.ViewHolder scrap = scrapList.get(i);
            if (scrap.isRemoved()) {
                continue;
            }
    ...
    private void updateAnchorInfoForLayout(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state,
     ...
     */
    private boolean updateAnchorFromChildren(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                             tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
     ...
     */
    private boolean updateAnchorFromPendingData(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (state.isPreLayout() || mPendingScrollPosition == NO_POSITION) {
            return false;
        }
     ...
     */
    private int fixLayoutEndGap(int endOffset, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                  tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     */
    @Override
    public int scrollHorizontallyBy(int dx, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
            tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
     ...
     */
    @Override
    public int scrollVerticallyBy(int dy, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
            tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
            return 0;
        }
    ...
    @Override
    public int computeHorizontalScrollOffset(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeVerticalScrollOffset(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeHorizontalScrollExtent(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeVerticalScrollExtent(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeHorizontalScrollRange(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    @Override
    public int computeVerticalScrollRange(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    private int computeScrollOffset(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private int computeScrollExtent(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private int computeScrollRange(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
            boolean canUseExistingSpace, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
    ...
    int gatherPrefetchIndicesForLayoutState(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, LayoutState layoutState,
                                            int[] outIndices) {
    ...
    @Override
    int gatherPrefetchIndices(int dx, int dy, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, int[] outIndices) {
    ...
    int scrollBy(int dy, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
     ...
     */
    private void recycleChildren(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, int startIndex, int endIndex) {
     ...
     *
     * @param recycler Recycler instance of {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView}
     * @param dt       This can be used to add additional padding to the visible area. This is used
     *                 to detect children that will go out of bounds after scrolling, without
     *                 actually moving them.
     */
    private void recycleViewsFromStart(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, int dt) {
        if (dt < 0) {
            if (DEBUG) {
     ...
     *                 actually moving them.
     */
    private void recycleViewsFromEnd(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, int dt) {
        final int childCount = getChildCount();
        if (dt < 0) {
            if (DEBUG) {
     ...
     * @see #recycleViewsFromStart(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler, int)
     * @see tv.onairm.com.layoutmanagerdemo.study.LinearLayoutManager.LayoutState#mLayoutDirection
     */
    private void recycleByLayoutState(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, LayoutState layoutState) {
     ...
     * independent from the rest of the {@link tv.onairm.com.layoutmanagerdemo.study.LinearLayoutManager}
     ...
     */
    int fill(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, LayoutState layoutState,
             tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state, boolean stopOnFocusable) {
    ...
    void layoutChunk(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state,
     ...
     */
    private View findReferenceChildClosestToEnd(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                                tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler,
                                                  tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return mShouldReverseLayout ? findLastReferenceChild(recycler, state) :
                findFirstReferenceChild(recycler, state);
    }

    private View findFirstReferenceChild(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private View findLastReferenceChild(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1, state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state,
     ...
     *
     * @return The adapter position of the first visible item or {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView#NO_POSITION} if
     ...
     * {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView#NO_POSITION} if there aren't any visible items.
     ...
     * are ignored in this method.
     *
     * @return The adapter position of the last visible view or {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView#NO_POSITION} if
     * there aren't any visible items.
     * @see #findLastCompletelyVisibleItemPosition()
     * @see #findFirstVisibleItemPosition()
     */
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
                                    tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
        resolveShouldLayoutReverse();
        if (getChildCount() == 0) {
            return null;
        }
    ...
    static class LayoutState {
        ...
        /**
         * Equal to {@link tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State#isPreLayout()}. When consuming scrap, if this value
        ...
        /**
         * The most recent {@link #scrollBy(int, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State)}
         * amount.
         */
         ...
         */
        List<tv.onairm.com.layoutmanagerdemo.study.RecyclerView.ViewHolder> mScrapList = null;
         ...
         */
        boolean hasMore(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
         ...
         */
        View next(tv.onairm.com.layoutmanagerdemo.study.RecyclerView.Recycler recycler) {
            if (mScrapList != null) {
    ...
    class AnchorInfo {
        ...
        boolean isViewValidAsAnchor(View child, tv.onairm.com.layoutmanagerdemo.study.RecyclerView.State state) {
